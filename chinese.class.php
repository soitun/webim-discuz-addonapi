...
class Chinese {
	...
	var $config  =  array
		(
		'SourceLang'            => '',                    //note  original charset
		'TargetLang'            => '',                    //note  target charset
		'GBtoUnicode_table'     => 'gb-unicode.table',    //note  GB2312 to unicode
		'BIG5toUnicode_table'   => 'big5-unicode.table',  //note  BIG5 to unicode
		);
